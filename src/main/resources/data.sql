...
INSERT INTO product_details(country_of_origin, expiry_date, image, manufacturer, production_year)
    VALUES ('Serbia', '12-31-2017', 'https://www.menda.rs/sites/default/files/styles/subcategories/public/kolica-za-bebe-quinny-moodd-purple-pace-76608340.png?itok=O6YMv3RB', 'Random', 2017);

INSERT INTO product(name, stock, price, category_id, details_id)
	VALUES ('Kolica', 12, 100.00, 1, 1);